...
```{r}
fit3 <- lm(log(death) ~ date + season + tmpd + dptp + no2tmean + pm10, data = ny)
...
rf <- randomForest(death ~ tmpd + dptp + dow + date + season + pm10 + o3tmean + no2tmean, data = ny, na.action = na.omit)
