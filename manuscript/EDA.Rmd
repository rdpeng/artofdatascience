...
```{r,fig.cap="Boxplot of ozone values by state",cache=TRUE}
...
```{r,warning=FALSE,message=FALSE,fig.cap="Map of East and West Regions"}
library(maps)
map("state")
abline(v = -100, lwd = 3)
text(-120, 30, "West")
...
```{r,fig.cap="Boxplot of Ozone for East and West Regions"}
